...
public class ShowIndexDataTest {
    ...
    public void getLatestIndexDataTest() throws IOException {
        ...
        assertEquals(-0.16867134987618593,indexVO.getIncrease_decreaseRate()[870],0.01);
    ...
    public void getIndexDataBetweenTest(){
        ...
        assertEquals(-0.16867134987618593,indexVO.getIncrease_decreaseRate()[0],0.01);
        assertEquals(-5.3400000000001455,indexVO.getIncrease_decreaseNum()[0],0.01);
    }

    @Test
    public void showCurrentIndexDataTest(){
        ShowIndexData showIndexData = new ShowIndexData();
        CurrentIndexVO currentIndexVO = showIndexData.showCurrentIndexData();
        assertNotNull(currentIndexVO.getCurrentPrice());
    }
