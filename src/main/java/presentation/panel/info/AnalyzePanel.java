...
public class AnalyzePanel extends OperationPanel {
    ...
    AnalyzePanel(JPanel parent, StockVO stock) throws SQLException {
    ...
    public AnalyzePanel(JPanel parent, IndexVO indexVO) throws SQLException {
    ...
    @Override
    protected void createUIComponents() throws SQLException {
        back = new JButton("返回");
    ...
    private class ConclusionPanel extends JPanel {
        ...
        ConclusionPanel() throws SQLException {
            init();
            createUIComponents();
        }
