 ...
 */
public class StockKLine_Daily implements ChartMouseListener{
    ...
    public StockKLine_Daily(String stockID) throws IOException {
    ...
    public void createChart(String stockID) throws IOException {
        ...
        drawKLineHelper.addPMA(stockVO,90,1);
        ...
        drawKLineHelper.setXAxis(x1Axis,stockVO.getDate()[num-90],stockVO.getDate()[num-1]);
